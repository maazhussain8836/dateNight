  ...
  const renderItem=({item, index})=> {
    ...
    return (
      <View >
        ...
        <LinearGradient colors={['#2BD13C', '#2BD13C']}
          ...
          <View style={styles.container}>
            ...
            <View style={{ flex: 3, }}>
            <Text style={{ ...styles.cardD, fontSize: 18,textAlign:'left' }}>Plan your next date</Text>
            <Text style={styles.cardD}>Name : Maaz Hussain</Text>
              ...
              <Text style={styles.cardD}>Frequency : Weekly</Text>
            </View>
            ...
            <View style={{
              ...
              <TouchableOpacity onPress={activefunc}>
                <Text style={styles.cardD}>Active</Text>
              </TouchableOpacity>
            </View>
