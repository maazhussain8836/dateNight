...
const AddPerson = ({navigation, route}) => {
  ...
  const onSave = () => {
    ...
    context.personDetails.push(d);
    console.log(context.personDetails);
    context.setAddPerson(false);
    navigation.navigate('Home', {navigation});
    // context.setAddNewCard(true)
  };

  return (
    <ScrollView style={{backgroundColor: '#24202F'}}>
      <View style={{paddingBottom: '40%'}}>
        ...
        <View style={styles.ImgV}>
          {img && <Image source={{uri: img}} style={styles.headImg} />}
        ...
        <View style={styles.container}>
          ...
          <View style={styles.InputView}>
            ...
            <MaskInput
              ...
              onChangeText={(masked, unmasked) => {
                setMobNum(masked); // you can use the unmasked value as well
          ...
          <View
            ...
            <TouchableOpacity onPress={showDatePicker}>
              <Text
                style={{fontSize: 16, color: '#FFF', fontFamily: 'poppins'}}>
                {' '}
                {dob}
              </Text>
            </TouchableOpacity>
          ...
          <View
            ...
            <Text style={{fontSize: 16, color: '#FFF', fontFamily: 'poppins'}}>
          ...
          <View style={styles.bgView}>
            <TouchableOpacity style={styles.bg} onPress={showBorderA}>
              <LinearGradient
                colors={[gradientCol[0].A1, gradientCol[0].A2]}
                style={[
                  borderA == true
                    ? styles.activeBorder
            ...
            <TouchableOpacity style={styles.bg} onPress={showBorderB}>
              <LinearGradient
                colors={[gradientCol[0].B1, gradientCol[0].B2]}
                style={[
                  borderB == true
                    ? styles.activeBorder
                    : styles.nonActiveBorder,
            ...
            <TouchableOpacity style={styles.bg} onPress={showBorderC}>
              <LinearGradient
                colors={[gradientCol[0].C1, gradientCol[0].C2]}
                style={[
                  borderC == true
                    ? styles.activeBorder
                    : styles.nonActiveBorder,
            ...
            <TouchableOpacity style={styles.bg} onPress={showBorderD}>
              <LinearGradient
                colors={[gradientCol[0].D1, gradientCol[0].D2]}
                style={[
                  borderD == true
                    ? styles.activeBorder
                    : styles.nonActiveBorder,
            ...
            <TouchableOpacity style={styles.bg} onPress={showBorderE}>
              <LinearGradient
                colors={[gradientCol[0].E1, gradientCol[0].E2]}
                style={[
                  borderE == true
                    ? styles.activeBorder
                    : styles.nonActiveBorder,
